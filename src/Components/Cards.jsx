  ...
  return <div className="col">
                <div className="card" style={{ width: '18rem' }}>
                    ...
                    <div className="d-flex justify-content-end w-auto">                        
                        <button className='btn btn-success btn-sm w-auto' onClick={handleEdits}>{save}</button>

                        &nbsp;
                        <div><button className="btn btn-danger btn-sm w-auto" onClick={Delete}>Delete</button></div>
